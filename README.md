...
| [#9](https://leetcode.cn/problems/palindrome-number/)        | [isPalindrome](https://github.com/JunLiangWangX/js-algorithm/blob/main/9.isPalindromes.js) | 给你一个整数，如果其是一个回文整数，返回true；否则返回false。 | Given an integer, return true if it is a palindrome; otherwise return false. |
